...
hist_path = os.path.abspath('/Users/mfm45/drop/test_getBinKinematics/test_getBinKinematicsTH2Ds__1_24_25__pipim/out_binscheme_kinematics.root')
...
xlims = {'mass_pipim':[0.0,3.0],'phperp_pipim':[0.0,1.25],'phperp2_pipim':[0.0,1.6],'z_pipim':[0.0,1.0]}
...
outpath = f'rgh_kinematics_pipim/rgh_kinematics_2d_{kinvar_x}_{kinvar_y}.pdf'
