...
hist_path = os.path.abspath('/Users/mfm45/drop/test_getBinKinematics/test_getBinKinematicsTH2Ds__1_24_25__pipim_22GeV/out_binscheme_kinematics.root')

kinvar_x, kinvar_y = ['z_pipim', 'phperp2_pipim']
xlabels = {'mass_pipim':'$M_{\\pi^{+}\\pi^{-}}$ (GeV)','phperp_pipim':'$P_{\\perp, \\pi^{+}\\pi^{-}}$ (GeV)','phperp2_pipim':'$P^{2}_{\\perp, \\pi^{+}\\pi^{-}}$ (GeV$^{2}$)','z_pipim':'$z_{\\pi^{+}\\pi^{-}}$'}
xlims = {'mass_pipim':[0.0,3.0],'phperp_pipim':[0.0,3.0],'phperp2_pipim':[0.0,3.0],'z_pipim':[0.0,1.0]}
hist_colors = {'mass_pipim':['tab:blue'],'phperp_pipim':['tab:red'],'phperp_pipim':['tab:green'],'z_pipim':['tab:orange']}
...
outpath = f'rgh_kinematics_pipim_22GeV/rgh_kinematics_2d_{kinvar_x}_{kinvar_y}_22GeV.pdf'
