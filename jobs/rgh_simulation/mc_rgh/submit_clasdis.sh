...
# Run clasdis event generation #TODO: ADD NEGATIVE POLARIZATION SAMPLE?
nohup clasdis --zpos -4.5 --zwidth 5.0 --targ proton --nont --nmax 10000 --parj21 0.6 --beam $BEAM_ENERGY_RGH --raster 1.8 --trig 10000000 --pol 1 --path ${PREFIX}
