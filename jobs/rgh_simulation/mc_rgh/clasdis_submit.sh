...
if ((!$CLASDIS_GEN_PM)); then
    ...
    nohup $RGH_CLADIS_COMMAND --zpos $CLASDIS_ZPOS --zwidth $CLASDIS_ZWIDTH --targ $CLASDIS_TARG --nont --nmax $CLASDIS_NMAX --parj21 $CLASDIS_PARJ21 --beam $BEAM_ENERGY_RGH --raster $CLASDIS_RASTER --trig $CLASDIS_TRIG --pol $CLASDIS_POL --path ${CLASDIS_PREFIX}
...
# Positive and negative target polarization split
    ...
    nohup $RGH_CLADIS_COMMAND --zpos $CLASDIS_ZPOS --zwidth $CLASDIS_ZWIDTH --targ $CLASDIS_TARG --nont --nmax $CLASDIS_NMAX --parj21 $CLASDIS_PARJ21 --beam $BEAM_ENERGY_RGH --raster $CLASDIS_RASTER --trig $CLASDIS_TRIG_HALF --pol $CLASDIS_POL --path ${CLASDIS_PREFIX}${CLASDIS_POL}_
    nohup $RGH_CLADIS_COMMAND --zpos $CLASDIS_ZPOS --zwidth $CLASDIS_ZWIDTH --targ $CLASDIS_TARG --nont --nmax $CLASDIS_NMAX --parj21 $CLASDIS_PARJ21 --beam $BEAM_ENERGY_RGH --raster $CLASDIS_RASTER --trig $CLASDIS_TRIG_HALF --pol -$CLASDIS_POL --path ${CLASDIS_PREFIX}-${CLASDIS_POL}_
