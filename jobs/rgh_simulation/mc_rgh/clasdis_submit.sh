...
if ((!$CLASDIS_GEN_PM)); then
    ...
    nohup $RGH_CLADIS_COMMAND --zpos -4.5 --zwidth 5.0 --targ $CLASDIS_TARG --nont --nmax $CLASDIS_NMAX --parj21 0.6 --beam $BEAM_ENERGY_RGH --raster 1.8 --trig $CLASDIS_TRIG --pol $CLASDIS_POL --path ${CLASDIS_PREFIX}
...
# Positive and negative target polarization split
    ...
    nohup $RGH_CLADIS_COMMAND --zpos -4.5 --zwidth 5.0 --targ $CLASDIS_TARG --nont --nmax $CLASDIS_NMAX --parj21 0.6 --beam $BEAM_ENERGY_RGH --raster 1.8 --trig $CLASDIS_TRIG_HALF --pol $CLASDIS_POL --path ${CLASDIS_PREFIX}${CLASDIS_POL}_
    nohup $RGH_CLADIS_COMMAND --zpos -4.5 --zwidth 5.0 --targ $CLASDIS_TARG --nont --nmax $CLASDIS_NMAX --parj21 0.6 --beam $BEAM_ENERGY_RGH --raster 1.8 --trig $CLASDIS_TRIG_HALF --pol -$CLASDIS_POL --path ${CLASDIS_PREFIX}-${CLASDIS_POL}_
